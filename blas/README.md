# Gonum BLAS [![GoDoc](https://godoc.org/github.com/ArkaGPL/gonum/blas?status.svg)](https://godoc.org/github.com/ArkaGPL/gonum/blas)
...
## Installation
```sh
  go get github.com/ArkaGPL/gonum/blas/...
```
